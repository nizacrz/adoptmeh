    ...
    <section id=home>
        ...
        <div class="about-section">
            <div class="inner-container">
                <h2>About Us</h2>
                <p class="text">
                    The company “adoptmeh.com” was founded by Team Cascaders, students of T.I.P Quezon City. Adoptmeh is a non-profit organization that is dedicated to promoting adoption and rescue to the voiceless animals that need a forever home and a family that can give
                    them a second chance in life. The organization aims to create an adoption and rescue web system concerning animal welfare, animal care, animal control, and other animal-related concerns where people can browse and select the rescued
                    pet they want to adopt before physically going to the shelter.
                </p>
                <div class="skills">
                    <span>For Dogs</span>
                    <span>For Cats</span>
        ...
        <div class="pricing-table">
            <div class="pricing-card">
                <h3 class="pricing-card-header">GCASH</h3>
                <ul>
                    <li><strong> To Donate via Gcash: </strong></li>
                    <li> 1. Log in to your Gcash account then tap on QR on your navigation bar. </li>
                    <li> 2. Click the button and align your phones camera to scan it. </li>
                    <li> 3. Input the total amount and tap Next. </li>
                    <li> 4. Review the details then tap pay. </li>
                </ul>
                <a href="gcash.html" class="order-btn">Donate Now</a>
            </div>

            <div class="pricing-card">
                <h3 class="pricing-card-header">PAYMAYA</h3>
                <ul>
                    <li><strong> To Donate via Paymaya: </strong></li>
                    <li> 1. Log in to your Paymaya account then tap on QR on your navigation bar. </li>
                    <li> 2. Click the button and align your phones camera to scan it. </li>
                    <li> 3. Input the total amount and tap Next. </li>
                    <li> 4. Review the details then tap pay. </li>
                </ul>
                <a href="paymaya.html" class="order-btn">Donate Now</a>
            </div>
        </div>
