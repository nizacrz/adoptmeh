...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" type="text/css" href="petinformation.css">
...
<body>
    ...
    <section id=home>
        ...
        <div class="appform">
            <h1>Current/Previous Pet Information</h1>
        </div>
        <div class="appli">
            <form>
                <h2 class="ques-1">Have your children been around animals before?</h2>
                ...
                <h2 class="ques-2">Does anyone in your home have allergies to dogs or have asthma?</h2>
                ...
                <h2 class="list">List any pets you own or have owned in the past five years, and their ages.</h2>
                <textarea class="list-pets"></textarea>

                <h2 class="sprayed">How many of these pets are sprayed/neutered?</h2>
                <input class="num_neutered" type="text" name="num_neutered">

                <h2 class="place">Where are these animals now?</h2>
                <textarea class="place-pets"></textarea>

                <h2 class="ques-3">Have you adopted from an animal welfare group before?</h2>
                ...
                <h2 class="group">How many of these pets are sprayed/neutered?</h2>
                <input class="name-group" type="text" name="name-group">

                <h2 class="ques-3">Have you ever given up a pet?</h2>
                ...
                <h2 class="circumstances">If yes, what were the circumtances</h2>
                <textarea class="list-circumstances"></textarea>

                <h2 class="vet">Please provide the name and phone number of your current and/or previous veterinarian or clinic:</h2>
                <textarea class="vet-details"></textarea>

                <p class=pledge> <input type="checkbox" class="checkbox" /> I understand that I assume full responsibility for the welfare of this pet from the date of adoption.</p>
