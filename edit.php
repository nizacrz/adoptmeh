...
include "dbconnection.php";
    ...
    $dog_description="";
    $image="";
    $res=mysqli_query($conn,"select * from dogs where id=$id");
...
<section id=home>
  ...
  <img src="<?php echo $image; ?>" height="200" width="200" >
    ...
    <div class="form-group">
      <label for="dog_id"><b>Dog ID:</label>
      <input type="text" class="form-control" id="dog_id" placeholder="Enter Dog ID" name="dog_id" value="<?php echo $dog_id; ?>">
    </div>
    <div class="form-group">
      <label for="dog_name">Dog Name:</label>
      <input type="text" class="form-control" id="dog_name" placeholder="Enter Dog Name" name="dog_name" value="<?php echo $dog_name; ?>">
    </div>
    <div class="form-group">
      <label for="dog_description">Dog Description:</label>
      <input type="text" class="form-control" id="dog_description" placeholder="Enter Dog Description" name="dog_description" value="<?php echo $dog_description; ?>">
    </div>
...
<?php
    if(isset($_POST["update"])) {
      ...
      if($fnm=="")
      {
        mysqli_query($conn,"update dogs set dog_id='$_POST[dog_id]',dog_name='$_POST[dog_name]',dog_description='$_POST[dog_description]' where id=$id");
      }
      else
      {
        ...
        mysqli_query($conn,"update dogs set
        dog_id='$_POST[dog_id]',dog_name='$_POST[dog_name]', dog_description='$_POST[dog_description]', image='$dst1' where id=$id");
      }
?>
