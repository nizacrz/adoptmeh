...
<section id=home>
        ...
        <div class="collapse navbar-collapse" id="main-navigation">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="cats.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Find a Pet
          </a>
    ...
    <h2 class="title"> Database for Cats</h2>

  <form action=" " name=form1 method="post" enctype="multipart/form-data">
    <div class="form-group">
      <label for="cat_id">Cat ID:</label>
      <input type="text" class="form-control" id="cat_id" placeholder="Enter Cat ID" name="cat_id">
    </div>
    <div class="form-group">
      <label for="cat_name">Name:</label>
      <input type="text" class="form-control" id="cat_name" placeholder="Enter Cat Name" name="cat_name">
    </div>
    <div class="form-group">
      <label for="cat_description">Description:</label>
      <input type="text" class="form-control" id="cat_description" placeholder="Enter Cat Description" name="cat_description">
    </div>
    ...
    <button type="submit" name="insert" class="btn btn-default" style="margin-left:1.3in"><i class="fas fa-plus"></i> Add Cat </button>
    </div>
  </form>
</div>
...
while($row=mysqli_fetch_array($res)) {
    ...
    echo "<td>"; echo $row["cat_description"]; echo "</td>";

	echo "<td>"; ?> <a href="editcat.php?id=<?php echo $row["id"]; ?>"<button type="button"
	class="btn btn-success"><i class="far fa-edit"></i> Edit</button></a> <?php echo "</td>";
	echo "<td>"; ?> <a href="deletecat.php?id=<?php echo $row["id"]; ?>"<button type="button"
...
if(isset($_POST["insert"])) {
    ...
    mysqli_query($conn,"insert into cats
    values(NULL,'$_POST[cat_id]','$_POST[cat_name]','$_POST[cat_description]','$dst1')");
